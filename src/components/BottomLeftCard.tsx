  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.98 }}
        onClick={() => window.open('https://t.me/frenixai', '_blank')}
      ...
      >
        <div className="bg-[rgba(30,50,90,0.1)] p-1 rounded-full flex items-center justify-center transition-colors group-hover:bg-[rgba(30,50,90,0.15)]">
